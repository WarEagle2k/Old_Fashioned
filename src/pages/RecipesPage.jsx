  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
      ...
      <div className="mb-10 animate-slide-up">
        <p className="text-amber font-body text-sm font-bold uppercase tracking-widest mb-2">Collection</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 glass text-cream placeholder:text-dusty/30 rounded-xl font-body text-sm focus:outline-none focus:border-amber/30 focus:ring-1 focus:ring-amber/20 transition-all"
          />
        </div>
        <select
          value={sortBy}
          onChange={(e) => setSortBy(e.target.value)}
          className="px-4 py-2.5 glass text-cream rounded-xl font-body text-sm focus:outline-none focus:border-amber/30 appearance-none cursor-pointer min-w-[160px]"
        >
          {sortOptions.map((opt) => (
